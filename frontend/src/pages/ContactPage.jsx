                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="card p-4 flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+923715813257" className="font-semibold text-sm hover:text-[var(--primary)] transition-colors" style={{ color: 'var(--text-main)' }}>
                                    +92 371 5813257
                                </a>
                            </div>
                        </div>
                        ...
                        {/* WhatsApp Link Card */}
                        <a href="https://wa.me/923715813257" target="_blank" rel="noreferrer" className="card p-5 flex items-center gap-4 transition-all hover:shadow-lg" style={{ textDecoration: 'none' }}>
