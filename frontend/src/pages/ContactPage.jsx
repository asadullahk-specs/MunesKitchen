                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="card p-4 flex items-center gap-4">
                            <div className="w-12 h-12 rounded-[7px]-[7px] flex items-center justify-center shrink-0 shadow-lg" style={{ background: 'linear-gradient(135deg, var(--primary), var(--primary-dark))' }}>
                        ...
                        <a href="https://wa.me/923032683689" target="_blank" rel="noreferrer" className="card p-5 flex items-center gap-4 transition-all hover:shadow-lg" style={{ textDecoration: 'none' }}>
                            <div className="w-12 h-12 rounded-[7px]-[7px] flex items-center justify-center shrink-0 shadow-lg" style={{ background: '#25D366' }}>
                        ...
                        {/* Notice Card */}
                        <div className="rounded-[7px]-[7px] p-4 text-sm flex items-center gap-2" style={{ background: 'var(--primary-glow)', border: '1px solid rgba(153,0,0,0.18)', color: 'var(--text-muted)' }}>
