        ...
        <div style={{ width: '100%', fontFamily: 'Poppins, sans-serif' }}>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="p-2.5 rounded-[7px] border flex items-center justify-center transition-all"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {Array.from({ length: 3 }).map((_, i) => (
                        <div key={i} className="card p-4 animate-pulse space-y-4">
                            <div className="w-full h-40 bg-gray-200 dark:bg-gray-800 rounded-[7px]" />
                        ...
                        >
                            ...
                            <div className="relative h-44 w-full bg-slate-100 dark:bg-slate-900 flex items-center justify-center overflow-hidden">
                                ...
                                {offer.discount_percentage > 0 && (
                                    <span className="absolute top-3 left-3 bg-red-500 text-white text-[11px] font-black uppercase tracking-wider px-2.5 py-1 rounded-[7px] shadow-md">
                                ...
                                <button
                                    ...
                                    className="absolute top-3 right-3 text-[10px] font-bold tracking-wider uppercase px-2.5 py-1 rounded-[7px] shadow-md transition-all active:scale-95"
                                    style={{
            ...
            <AnimatePresence>
                {showModal && (
                    ...
                    >
                        <motion.div
                            className="w-full sm:max-w-xl rounded-[7px]-t-[7px] sm:rounded-[7px] overflow-hidden"
                            style={{
                            ...
                            <form onSubmit={handleSave}>
                                ...
                                <div className="p-5 flex flex-col gap-4 overflow-y-auto" style={{ maxHeight: '65vh' }}>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="p-3.5 rounded-[7px] flex items-center justify-between text-xs" style={{ background: 'var(--bg-deep)', border: '1px dashed var(--border)' }}>
                                ...
                                <div className="p-5 flex justify-end gap-2 border-t" style={{ borderColor: 'var(--border)', background: 'var(--bg-deep)' }}>
                                    <button
                                        type="button"
                                        onClick={() => setShowModal(false)}
                                        className="px-5 py-2.5 rounded-[7px] border text-sm font-semibold transition-colors"
