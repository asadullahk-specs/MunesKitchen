            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="max-w-md mx-auto mb-8 relative">
                    <input
                        type="text"
                        placeholder="Search..."
                        className="w-full px-5 py-3 rounded-[7px] border transition-all text-sm pr-12 focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] outline-none"
                        style={{
                ...
                <div className="hidden sm:block">
                    ...
                    >
                        <button
                            ...
                            className="px-5 py-2.5 rounded-[7px] font-medium text-sm transition-all"
                            style={{
                ...
                <div className="block sm:hidden mb-6">
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            onClick={() => handleCategoryChange('all')}
                            className="flex items-center justify-center gap-2 py-3 rounded-[7px] font-semibold text-sm transition-all"
                            style={{
                                background: activeCategory === 'all' ? 'linear-gradient(135deg, var(--primary), var(--primary-dark))' : 'var(--bg-card)',
                                color: activeCategory === 'all' ? 'white' : 'var(--text-muted)',
                                border: activeCategory === 'all' ? 'none' : '1.5px solid var(--border)',
                            ...
                            {groupedProducts.map((group) => (
                                <div key={group.id} className="space-y-3">
                                    ...
                                    <div className="flex items-center justify-between border-b pb-2 px-1" style={{ borderColor: 'var(--border)' }}>
                                        ...
                                        <span className="text-xs px-2 py-0.5 rounded-[7px]" style={{ background: 'var(--primary-glow)', color: 'var(--primary)', fontWeight: 600 }}>
            ...
            <AnimatePresence>
                {filterDrawerOpen && (
                    <>
                        ...
                        {/* Slide-up Panel */}
                        <motion.div
                            className="fixed bottom-0 left-0 right-0 z-50 rounded-t-[7px] p-6 max-h-[80vh] overflow-y-auto sm:hidden border-t"
                        ...
                        >
                            <div className="flex items-center justify-between mb-6 pb-2 border-b" style={{ borderColor: 'var(--border)' }}>
                                ...
                                <button
                                    onClick={() => setFilterDrawerOpen(false)}
                                    className="p-1.5 rounded-[7px] bg-gray-100 dark:bg-zinc-800 transition-colors"
                            ...
                            <div className="space-y-2">
                                <button
                                    onClick={() => handleCategoryChange('all')}
                                    className="w-full text-left px-4 py-3 rounded-[7px] transition-all font-medium text-sm flex items-center justify-between"
                                    style={{
